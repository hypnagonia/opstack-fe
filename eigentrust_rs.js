...
* @returns {string}
*/
export function run(localtrust_csv, pretrust_csv, alpha) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(localtrust_csv, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(pretrust_csv, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.run(retptr, ptr0, len0, ptr1, len1, alpha);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('eigentrust_rs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
